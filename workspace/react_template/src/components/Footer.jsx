      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              A comprehensive MERN stack application with production-ready
              deployment configuration for CI/CD and monitoring.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} PrimaCodex MERN Stack Deployment. All
            rights reserved.
          </p>
        </div>
      </div>
